...
DROP FUNCTION IF EXISTS changeset_new(v_operation text, v_params jsonb, v_user_id text) CASCADE;
DROP FUNCTION IF EXISTS changeset_reset(v_operation text, v_params jsonb) CASCADE;
